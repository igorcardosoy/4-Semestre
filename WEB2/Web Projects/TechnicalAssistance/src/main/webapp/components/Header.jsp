<div class="navbar bg-base-100">
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <ul
        ...
        <li><a href="${pageContext.request.contextPath}/home/view/customer" class="btn btn-ghost">Clientes</a></li>
        <li><a href="${pageContext.request.contextPath}/home/view/order" class="btn btn-ghost">Serviços</a></li>
        <li><a href="${pageContext.request.contextPath}/home/view/payment-method" class="btn btn-ghost">Formas de Pagamento</a></li>
        <li><a href="${pageContext.request.contextPath}/home/view/status" class="btn btn-ghost">Status</a></li>
      </ul>
    </div>
  ...
  <div class="navbar-center hidden lg:flex">
    <ul class="menu menu-horizontal px-1 gap-3">
      <li><a class="btn btn-outline btn-primary" href="${pageContext.request.contextPath}/home/view/customer">
        ...
        Cliente</a></li>
      <li><a class="btn btn-outline btn-primary" href="${pageContext.request.contextPath}/home/view/order">
        ...
        Servico</a></li>
      <li><a class="btn btn-outline btn-primary" href="${pageContext.request.contextPath}/home/view/payment-method">
      ...
      <li><a class="btn btn-outline btn-primary" href="${pageContext.request.contextPath}/home/view/status">
