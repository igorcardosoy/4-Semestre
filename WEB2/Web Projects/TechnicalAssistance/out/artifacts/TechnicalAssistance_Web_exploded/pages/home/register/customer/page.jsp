  	...
  	<main class="w-full flex items-center justify-center">
			<div class="container mt-32 mb-32">
				<div class="flex justify-center">
					...
					<form id="form" action="${pageContext.request.contextPath}/home/register/customer" method="post" class="mt-5">
						...
						<div class="flex gap-3 mt-5 justify-center">
							...
							<div class="alert flex items-center justify-center flex-wrap max-w-80">
								...
								<label class="input input-bordered flex items-center gap-2">
									...
									<input id="zipcode" name="zipcode" type="number" class="grow" placeholder="CEP" required />
								</label>
								...
								<label class="input input-bordered flex items-center gap-2">
									...
									<input id="street" name="street" type="text" class="grow" placeholder="Rua" required />
								</label>
								...
								<label class="input input-bordered flex items-center gap-2">
									...
									<input id="number" name="number" type="text" class="grow" placeholder="Número" required />
								</label>
								...
								<label class="input input-bordered flex items-center gap-2">
									...
									<input id="neighborhood" name="neighborhood" type="text" class="grow" placeholder="Bairro" required />
								</label>
								...
								<label class="input input-bordered flex items-center gap-2">
									...
									<input id="city" name="city" type="text" class="grow" placeholder="Cidade" required />
								</label>
								...
								<label class="input input-bordered flex items-center gap-2">
									...
									<input id="state" name="state" type="text" class="grow" placeholder="Estado" required />
								</label>
