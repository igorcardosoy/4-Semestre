...
<main class="w-full flex items-center justify-center">
  <div class="container mx-auto max-w-80 mt-32">
    <div>
      ...
      <form id="form" action="${pageContext.request.contextPath}/home/${action}/payment-method" method="post" class="mt-5">
          ...
          <div class="alert flex items-center justify-center flex-wrap">
              ...
              <c:choose>
                ...
                <label class="input input-bordered flex items-center gap-2">
                  ...
                  <input name="code" type="number" class="hidden" placeholder="Code" value="${paymentMethod.getCode()}">
                  <input type="number" class="grow" value="${paymentMethod.getCode()}" disabled>
                </label>
                </c:when>
              </c:choose>
            <label class="input input-bordered flex items-center gap-2">
              ...
              <input name="name" type="text" class="grow" placeholder="Nome"  required="required"  value="${paymentMethod.getName()}">
            </label>
          </div>
        </div>
