<div class="flex justify-center gap-3">
  <div class="mt-5">
    <a class="btn btn-outline w-28" href="${pageContext.request.contextPath}/home/edit/${param.endpoint}?code=${param.code}">
  ...
  <div class="mt-5">
    <button onclick="${param.id}${param.code}.showModal()" class="btn btn-outline w-28">
