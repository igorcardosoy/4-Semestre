<div class="navbar bg-base-100">
  ...
  <div class="navbar-center hidden lg:flex">
    <ul class="menu menu-horizontal px-1 gap-3">
      <li><a class="btn btn-outline btn-primary" href="${pageContext.request.contextPath}/home/register/customer">
      ...
      <li><a class="btn btn-outline btn-primary" href="${pageContext.request.contextPath}/home/register/order">
        ...
        Cadastrar Servico</a></li>
      <li><a class="btn btn-outline btn-primary" href="${pageContext.request.contextPath}/home/register/payment-method">
