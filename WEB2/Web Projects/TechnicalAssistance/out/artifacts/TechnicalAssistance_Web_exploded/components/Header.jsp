...
<div class="navbar bg-base-100">
  ...
  <div class="navbar-center hidden lg:flex">
    <ul class="menu menu-horizontal px-1 gap-3">
      <li><a class="btn btn-primary" href="${pageContext.request.contextPath}/home/view/customer">
        ...
        Cliente</a></li>
      <li><a class="btn btn-primary" href="${pageContext.request.contextPath}/home/view/order">
        ...
        Servico</a></li>
      <li><a class="btn btn-primary" href="${pageContext.request.contextPath}/home/view/payment-method">
      ...
      <li><a class="btn btn-primary" href="${pageContext.request.contextPath}/home/view/status">
  ...
  <div class="navbar-end gap-2">
    ...
    <div class="dropdown dropdown-end">
      ...
      <ul
              tabindex="0"
              class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-36 p-2 shadow gap-2">
        <li>

          <a href="${pageContext.request.contextPath}/home/view/profile" class="btn btn-ghost">
        ...
        <li>
          <button class="btn btn-ghost" data-toggle-theme="dark,cupcake" data-act-class="ACTIVECLASS">
        ...
        <li>
          <a class="btn btn-ghost" href="${pageContext.request.contextPath}/signout">
